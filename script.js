...
const scrollDownIconBottom = document.querySelector(
  "[data-scroll-down-icon-bottom]"
);
...
let aboutTitleDistanceToTop =
  window.pageYOffset + aboutTitleElement.getBoundingClientRect().top;

let scrollTextElement = document.querySelector(".scroll-text");
let scrollTextDistanceToTop =
  window.pageYOffset + scrollTextElement.getBoundingClientRect().top;
let pxToScroll = aboutTitleDistanceToTop - scrollTextDistanceToTop;

window.addEventListener("resize", (e) => {
  aboutTitleDistanceToTop =
    window.pageYOffset + aboutTitleElement.getBoundingClientRect().top;
  scrollTextDistanceToTop =
    window.pageYOffset + scrollTextElement.getBoundingClientRect().top;
...
const backToTopIcons = [
  ...document.querySelectorAll("[data-back-to-top-icon]"),
];
...
function copyEmailToClipboard() {
  const emailAddress = "pranshukumar1999@gmail.com";
